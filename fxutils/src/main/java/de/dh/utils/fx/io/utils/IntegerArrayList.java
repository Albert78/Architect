...
public class IntegerArrayList extends AbstractList<Integer>
    ...
    private boolean batchRemove(Collection<?> c, boolean complement) {
        final int[] localElementData = this.elementData;
        int r = 0, w = 0;
    ...
    private class Itr implements Iterator<Integer> {
        ...
        @Override public Integer next() {
            ...
            int[] localElementData = IntegerArrayList.this.elementData;
     ...
     */
    @Override public IntegerArrayList subList(int fromIndex, int toIndex) {
        ...
        @Override public ListIterator<Integer> listIterator(final int index) {
            ...
            return new ListIterator<>() {
                ...
                @Override public void set(Integer e) {
                    ...
                    try {
                        IntegerArrayList.this.set(iteratorOffset + lastRet, e);
                    } catch (IndexOutOfBoundsException ex) {
                        throw new ConcurrentModificationException();
                    }
                }
