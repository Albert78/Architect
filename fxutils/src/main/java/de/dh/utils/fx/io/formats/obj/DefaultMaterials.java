...
public class DefaultMaterials {
    ...
    public static Map<String, RawMaterialData> createDefaultMaterials() {
        try (Reader r = new StringReader(JAVA_3D_MATERIALS)) {
            return MtlLibraryIO.readMaterialSet(r, null);
        } catch (IOException e) {
            throw new RuntimeException("Error loading default materials");
        }
    }
}
