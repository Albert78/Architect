...
import de.dh.cad.architect.ui.view.threed.behaviors.SelectionBehavior;

public class SelectionMode extends AbstractUiMode<Abstract3DRepresentation, Abstract3DAncillaryObject> {
    ...
    public Abstract3DViewBehavior getBehaviorForSelectedReprs(Collection<Abstract3DRepresentation> selectedReprs) {
        return new SelectionBehavior(this);
    }
}
