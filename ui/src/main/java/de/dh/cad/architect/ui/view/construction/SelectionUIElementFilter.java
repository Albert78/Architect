...
public class SelectionUIElementFilter extends ConstructionUIElementFilter {
    /**
     * Gets the information if the given UI element is visible.
     */
    @Override
    public boolean isUIElementVisible(Abstract2DRepresentation repr) {
        return !repr.getModelObject().isHidden() && !(repr instanceof AnchorConstructionRepresentation);
    }
}
