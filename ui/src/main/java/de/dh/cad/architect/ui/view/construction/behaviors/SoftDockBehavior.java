...
public class SoftDockBehavior extends AbstractDockBehavior {
    public SoftDockBehavior(AnchorConstructionRepresentation handleAnchorRepresentation, AbstractUiMode<Abstract2DRepresentation, Abstract2DAncillaryObject> parentMode) {
        super(handleAnchorRepresentation, parentMode);
    }

    @Override
    protected String getDockToSelectedAnchorTitle(Anchor anchor) {
        return MessageFormat.format(Strings.ACTION_SOFT_DOCK_TO_SELECTED_ANCHOR_TITLE, anchor.getId());
    }
    ...
    protected String getCancelDockActionTitle() {
        return Strings.ACTION_CANCEL_SOFT_DOCK;
    }
    ...
    protected String getInteractionsTabTitle() {
        return Strings.INTERACTIONS_TAB_SOFT_DOCK_OPERATION_TITLE;
    }

    @Override
    protected String getDockToTargetButtonTitle() {
        return Strings.DOCK_OPERATION_SOFT_DOCK_TO_TARGET_ANCHOR;
    }

    @Override
    public String getTitle() {
        return Strings.SOFT_DOCK_BEHAVIOR_TITLE;
    }
    ...
    protected String getDefaultUserHint() {
        return MessageFormat.format(Strings.SOFT_DOCK_BEHAVIOR_USER_HINT, BaseObjectUIRepresentation.getObjName(mHandleAnchor));
    }
}